/datum/design/item/medical/gelsuit
	...
	id = "gelsuit"
	req_tech = list(TECH_BIO = 3, TECH_MATERIAL = 3, TECH_DATA = 3) //relatively easy to acquire in case a crewmember loses their. Somehow.
...
/datum/design/item/medical/gelsuit_deluxe
	...
	desc = "Based on suits, worn by Carnifex ambassadors, this substance provides far more protection from environmental hazards, than its standard counterpart, while reducing oxygen intake even more."
	id = "gelsuit_deluxe"
