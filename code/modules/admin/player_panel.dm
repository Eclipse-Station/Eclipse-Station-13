		...
		<head>
			<script type='text/javascript'>
				...
				function expand(id,job,name,real_name,image,key,ip,antagonist,ref){
					...
					body += "<a href='?src=\ref[src];adminplayerobservejump="+ref+"'>JMP</a><br> - " //Eclipse Edit
					body += "<a href='?src=\ref[src];adminplayerobservefollow="+ref+"'>FLW</a><br>"  //Eclipse Edit: Added FLW as an option.
					if(antagonist > 0)
			...
			dat += {"
				...
				<tr id='data[i]' name='[i]' onClick="addToLocked('item[i]','data[i]','notice_span[i]')">
					<td align='center' bgcolor='[color]'>
						...
						>
						<span id='search[i]'><b>[M_name] - [M_rname] - [M_key] ([M_job])[M.client ? "" : " - (DC)"]</b></span> //Eclipse Edit: Added DC indicator.
						</a>
