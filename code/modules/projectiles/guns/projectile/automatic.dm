...
//	fire_sound = 'sound/weapons/Gunshot_heavy.ogg'
	...
	firemodes = list(
		...
		list(mode_name="4-round bursts", burst=4, burst_delay=1, fire_delay=4, move_delay=4, burst_accuracy = list(0,-1,-1,-2,-2), dispersion = list(0.0,0.6, 1.0, 1.0), fire_sound='sound/weapons/OLDAKburst.ogg'),
		)
