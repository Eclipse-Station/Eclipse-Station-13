...
/obj/singularity/proc/check_energy()
	...
	if (current_size != allowed_size && current_size != STAGE_SUPER)
		expand(null, current_size < allowed_size) //Eclipse Edit: Fixed singulo grow/shrink messages being backwards.
	return 1
...
/obj/singularity/proc/smwave()
	for(var/mob/living/M in view(10, src.loc))
		if(prob(67))
			...
			M << "<span class=\"danger\">You hear an unearthly ringing, then what sounds like a shrilling kettle as you are washed with a wave of heat.</span>"
