...
/datum/design/item/dufflebag_holding
	name = "'Duffel Bag of Holding', an infinite capacity duffel bag prototype"
	desc = "A miniaturized prototype of the popular Bag of Holding, the Duffel Bag of Holding is, functionally, identical to the bag of holding, but comes in a more stylish and compact form."
