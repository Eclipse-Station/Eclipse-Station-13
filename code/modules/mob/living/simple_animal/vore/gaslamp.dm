...
/mob/living/simple_animal/retaliate/gaslamp
	vore_active = 1
	vore_capacity = 2
	vore_bump_chance = 90 //they're frickin' jellyfish anemone filterfeeders, get tentacled
	...
	vore_pounce_chance = 5 // Small chance to punish people who abuse their nomming behavior to try and kite them forever with repeated melee attacks.
