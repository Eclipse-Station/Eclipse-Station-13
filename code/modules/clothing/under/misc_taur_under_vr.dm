/obj/item/clothing/under/rank/head_of_personnel/taur/dress
	...
	desc = "It's a jumpsuit worn by someone who works in the position of \"Head of Personnel\". It has a sticker saying one size fits all taurs on it. Below the sticker, it states that it only fits horses and wolves taurs."
	...
	mob_can_equip(var/mob/living/carbon/human/H, slot, disable_warning = 0)
		if(..())
			if(istype(H) && istype(H.tail_style, /datum/sprite_accessory/tail/taur/wolf))
				...
				icon_state = "dress_hop_horse_s"
				item_state = "dress_hop_horse"
				icon_override = 'icons/mob/taurunder_vr.dmi'
				pixel_x = -16
				worn_layer = 20
				return 0
...
/obj/item/clothing/suit/drakecloak/taur
