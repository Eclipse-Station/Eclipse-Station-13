...
*/
	...
	for(var/turf/simulated/floor/target_tile in range(0,location))
		target_tile.assume_gas("trichloramine", created_volume*4, 120+T0C)	//the remaining 80% of the reagent is turned into hot gas
		spawn (0) target_tile.hotspot_expose(120+T0C, 125)
	return