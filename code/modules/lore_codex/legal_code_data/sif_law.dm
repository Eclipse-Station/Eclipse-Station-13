/datum/lore/codex/category/sif_law
	name = "Sif Law"
	data = "This section contains the abbreviated Sif Governmental Authority legal code's potential charges for crimes that are relevant to \
	the reader."
	children = list(
...
/datum/lore/codex/page/law/slander
	name = "Slander / Libel"
	definition = "To spread false rumors in order to damage someone's reputation."
