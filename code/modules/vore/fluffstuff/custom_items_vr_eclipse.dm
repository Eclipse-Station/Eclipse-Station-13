...
*/
//Eclipse Edit: This .dm and the respective .dmi are to be used for items specific to Eclipse Station to avoid confusion and synchronization issues.

//Pixelexip:Casey Hall
/obj/item/clothing/glasses/sunglasses/fluff/clout
	name = "clout goggles"
	desc = "These ain't glasses, baby. These CLOUT GOGGLES."
	icon = 'modular_eclipse/icons/obj/custom_items_vr_eclipse.dmi'
	icon_state = "clout_goggles"

	icon_override = 'modular_eclipse/icons/obj/custom_clothes_vr_eclipse.dmi'
