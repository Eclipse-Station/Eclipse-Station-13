/obj/item/weapon/book/manual/resleeving
	...
	dat = {"<html>
				...
				All Nanotrasen Resleeving Technology (NRT) is licensed to Nanotrasen by Lazarus Foundation (NAME PATENT PENDING) on request of Sol Central Government. It should only be used in the ways set forth in this guide.
