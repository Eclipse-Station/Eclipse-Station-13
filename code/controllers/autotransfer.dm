...
datum/controller/transfer_controller/proc/process()
	...
	if (round_duration_in_ticks >= shift_last_vote - 2 MINUTES)
		...
		to_world("<b>Warning: This upcoming round-extend vote will be your [NUMBER_OF_VOTE_EXTENSIONS > 1 ? "FINAL" : "ONLY"] extend vote. Wrap up your scenes in the next 60 minutes if the round is extended.</b>") //VOREStation Edit //Eclipse-Station Edit: "FINAL" or "ONLY" depending on final or only.
