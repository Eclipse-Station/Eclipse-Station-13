...
/world/proc/update_status()
	...
	s += "</a>"
//	s += "[game_version]"
//	  //Replace this with something else. Or ever better, delete it and uncomment the game version. Eclipse-Edit
	s += "</a>"
	s += ")"
	s += "<br><small><i>HRP, antags (w/ vote, no murderbone), diverse character creation menu.</i></small><br>"
