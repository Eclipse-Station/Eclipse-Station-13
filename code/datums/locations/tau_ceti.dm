...
/datum/locations/luthien
	...
	military control over the few tiny population centers located near the poles."
...
/datum/locations/new_gibson
	name = "New Gibson"
	desc = "New Gibson is a medium sized, rocky planet that is covered in rampant industrialization. Containing the majority of the planet-bound \
...
/datum/locations/reade
	...
	Nowadays, what remains of that misguided re-colonization project makes up several cavernous, ruined cities (some of which are visible from orbit)."

/datum/locations/tau_ceti_vi
	name = "Tau Ceti VI"
	desc = "A small, cold world with a thin and unbreathable atmosphere and notably low gravity. Geological surveys over the centuries have cataloged \
	...
	seismic activity. The planet is completely void of anything making settlement worthwhile, but recently there have been rumors of illegitimate \
