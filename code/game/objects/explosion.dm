...
proc/explosion(turf/epicenter, devastation_range, heavy_impact_range, light_impact_range, flash_range, adminlog = 1, z_transfer = UP|DOWN, shaped)
	...
	spawn(0)
		...
		if(config.use_recursive_explosions)
			var/power = devastation_range * 2 + heavy_impact_range + light_impact_range //The ranges add up, ie light 14 includes both heavy 7 and devastation 3. So this calculation means devastation counts for 4, heavy for 2 and light for 1 power, giving us a cap of 27 power.
