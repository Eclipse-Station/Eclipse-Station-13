...
/obj/item/clothing
	...
	var/material_armor_modifer = 1 // Adjust if you want separate types of armor made from the same material to have different protectiveness (e.g. makeshift vs real armor)
