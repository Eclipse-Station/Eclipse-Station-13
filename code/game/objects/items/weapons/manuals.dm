...
/obj/item/weapon/book/manual/engineering_construction/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]Guide_to_Construction" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/engineering_hacking/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='97%' src="[config.wikiurl]Guide_to_Hacking" frameborder="0" id="main_frame"></iframe>
		</body>
...
/obj/item/weapon/book/manual/security_space_law/New()
	...
	dat = {"
		...
		<body>
		<iframe width='100%' height='100%' src="[config.wikiurl]Corporate_Regulations" frameborder="0" id="main_frame"></iframe>
		</body>
