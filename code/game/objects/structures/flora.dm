...
/obj/structure/flora/ausbushes/ywflowers/New()
	..()
	icon_state = "ywflowers_[rand(1, 4)]"		//Eclipse Edit: There's 4 different sprites for the yellow flowers.
...
/obj/structure/flora/ausbushes/ppflowers/New()
	..()
	icon_state = "ppflowers_[rand(1, 3)]"		//Eclipse Edit: There's only 3 different sprites for the purple flowers.
