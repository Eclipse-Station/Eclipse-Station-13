/datum/game_mode/traitor/bloodbath
	name = "traitor - bloodbath"
	round_description = "There is a foreign agent or traitor on the station. Do not let the traitor succeed! The fucker allowed to do heinous stuff."
