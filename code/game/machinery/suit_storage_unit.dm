...
/obj/machinery/suit_cycler/attack_hand(mob/user as mob)
	...
	user << browse(dat, "window=suit_cycler;size=400x435") //Eclipse-Station Edit: Opened too small when size was omitted.
...
/obj/machinery/suit_cycler/proc/apply_paintjob()
	...
	//Eclipse-Station Edit: Say hello to a less bloated way to do this. Lookup tables are in suit_storage_unit_vr.dm.
