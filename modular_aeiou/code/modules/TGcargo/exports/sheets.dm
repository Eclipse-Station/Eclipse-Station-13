...
/datum/export/stack/bscrystal
	...
	export_types = list(/obj/item/weapon/ore/bluespace_crystal)
...
/datum/export/stack/adamantine
	...
	export_types = list(/obj/item/stack/material/lead)

// Mythril. Does not occur naurally.
/datum/export/stack/mythril
	cost = 15000
	message = "of mythril"
	export_types = list(/obj/item/stack/material/mhydrogen)
