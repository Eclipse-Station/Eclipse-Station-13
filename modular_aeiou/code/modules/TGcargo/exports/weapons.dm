...
/datum/export/weapon/knife
	...
	export_types = list(/obj/item/weapon/material/knife/tacknife/combatknife)
...
/datum/export/weapon/shotgun
	...
	export_types = list(/obj/item/weapon/gun/projectile/shotgun/pump/combat)


/datum/export/weapon/flashbang
	cost = 15
	unit_name = "flashbang grenade"
	export_types = list(/obj/item/weapon/storage/box/flashbangs)
