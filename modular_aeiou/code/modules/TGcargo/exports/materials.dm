/datum/export/material
	...
	export_types = list(
		/obj/item/stack/material, /obj/item/stack/tile,
...
/datum/export/material/get_amount(obj/O)
	...
	if(!isitem(O))
		return 0
	var/obj/item/I = O
	if(!(material_id in I.material))
		return 0

	var/amount = I.material[material_id]
...
/datum/export/material/metal
	...
	export_types = list(
		/obj/item/stack/material/steel, /obj/item/stack/material/plasteel,
...
/datum/export/material/glass
	...
	export_types = list(/obj/item/stack/material/glass, /obj/item/weapon/ore, /obj/item/weapon/material/shard)
