...
/datum/export/weldingtool/industrial
	...
	export_types = list(/obj/item/weapon/weldingtool/largetank)

/datum/export/weldingtool/upgraded
	cost = 10
	unit_name = "upgraded welding tool"
	export_types = list(/obj/item/weapon/weldingtool/hugetank)
