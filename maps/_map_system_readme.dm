/*
This system is in place to make it easier to separate data specific to a certain map.
...
[map_name] folder
	...
	[map_name]-1.dmm - Your actual map files.  Z-levels should be ordered correctly if you separate your z-levels across map files.
